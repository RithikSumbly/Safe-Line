# Scam Message Safety Agent

## Project Details

**Track:** AAI  
**Difficulty Level:** Basic + Intermediate  
**Domain:** Cyber safety and digital trust  
...
Users receive suspicious SMS, WhatsApp, and email messages asking them to click links, pay money, or share personal details. Build an agent that detects scam signals and gives safe next steps.
...
Build a working solution for **Scam Message Safety Agent** that takes relevant input data, processes it through a clear workflow, and produces an actionable output for real users or decision-makers.
...
Risk score, red-flag checklist, safe action recommendation, family-friendly warning rewrite.
...
**Dataset / Reference Name:** FTC scam guidance + sample scam CSV

**Link:** https://consumer.ftc.gov/articles/job-scams

**How to Use It:**
Create starter CSV: message, channel, requested_action, money_request, urgency_words, link_present, risk_label.
